                ...
                echo '
                    <div class="card m-4" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul>
                                <li> author: ' . $hotel[5]['Wifi Connection'] . '</li>
                                <li> title: ' . $hotel[5]['Catering'] . '</li>
                                <li> year: ' . $hotel[5]['Swimming Pool'] . '</li>
                                <li> availability: ' . $hotel[5]['Parking'] . '</li>
                                </ul>    
                            </p>
                            ...
                            <form action="./checkout.php" method="get">
                                ...
                                <button type="submit" name="book" value="book" class="btn btn-success">
                                    Return
                                </button>
                                <button type="submit" name="book" value="book" class="btn btn-warning">
                                    Change
                                </button>
                                <button type="submit" name="book" value="book" class="btn btn-dark">
                                    Add another
                                </button>
                            </form>
                        </div>
